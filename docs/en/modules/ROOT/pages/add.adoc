...
dependencies {
    implementation 'com.github.stephengold:Libbulletjme:18.2.1'
}
----
...
You'll definitely need the class JAR ("Libbulletjme-18.2.1.jar")
...
.. Select the "Libbulletjme-18.2.1" file.
...
.. Select the "Libbulletjme-18.2.1-javadoc.jar" file.
.. Click on the btn:[Open] button.
.. Click on the btn:[Browse...] button to the right of "Sources:"
.. Select the "Libbulletjme-18.2.1-sources.jar" file.
