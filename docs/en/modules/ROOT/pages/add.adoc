...
dependencies {
    implementation 'com.github.stephengold:Libbulletjme:17.0.0'
}
----
...
You'll definitely want the class JAR ("Libbulletjme-17.0.0.jar")
...
.. Select the "Libbulletjme-17.0.0" file.
...
.. Select the "Libbulletjme-17.0.0-javadoc.jar" file.
.. Click on the btn:[Open] button.
.. Click on the btn:[Browse...] button to the right of "Sources:"
.. Select the "Libbulletjme-17.0.0-sources.jar" file.
