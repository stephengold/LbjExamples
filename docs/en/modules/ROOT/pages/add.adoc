...
You'll definitely want the class JAR ("Libbulletjme-16.2.1.jar")
...
.. Select the "Libbulletjme-16.2.1" file.
...
.. Select the "Libbulletjme-16.2.1-javadoc.jar" file.
.. Click on the btn:[Open] button.
.. Click on the btn:[Browse...] button to the right of "Sources:"
.. Select the "Libbulletjme-16.2.1-sources.jar" file.
