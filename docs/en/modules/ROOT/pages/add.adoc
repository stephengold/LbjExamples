...
{Project} requires at least 2 libraries: a JVM library and a native library.
...
I suggest starting out with the Debug-flavored AAR.
...
I suggest starting with the platform-independent JVM library
