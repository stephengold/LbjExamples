...
dependencies {
    implementation 'com.github.stephengold:Libbulletjme:17.5.2'
}
----
...
You'll definitely want the class JAR ("Libbulletjme-17.5.2.jar")
...
.. Select the "Libbulletjme-17.5.2" file.
...
.. Select the "Libbulletjme-17.5.2-javadoc.jar" file.
.. Click on the btn:[Open] button.
.. Click on the btn:[Browse...] button to the right of "Sources:"
.. Select the "Libbulletjme-17.5.2-sources.jar" file.
