...
dependencies {
    implementation 'com.github.stephengold:Libbulletjme:18.3.0'
}
----
...
You'll definitely need the class JAR ("Libbulletjme-18.3.0.jar")
...
.. Select the "Libbulletjme-18.3.0" file.
