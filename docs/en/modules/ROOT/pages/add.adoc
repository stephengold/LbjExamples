...
dependencies {
    implementation 'com.github.stephengold:Libbulletjme:15.2.1'
}
----
...
You'll want the class JAR ("Libbulletjme-15.2.1.jar")
...
.. Select the "Libbulletjme-15.2.1" file.
...
.. Select the "Libbulletjme-15.2.1-javadoc.jar" file.
.. Click on the btn:[Open] button.
.. Click on the btn:[Browse...] button to the right of "Sources:"
.. Select the "Libbulletjme-15.2.1-sources.jar" file.
