...
To visualize the bodies, `HelloRigidBody` uses the SPORT graphics engine
included in https://github.com/stephengold/LbjExamples[the LbjExamples project].
...
To change the time before deactivation (for all rigid bodies),
