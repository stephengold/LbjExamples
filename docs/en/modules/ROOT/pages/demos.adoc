...
** kbd:[Home], kbd:[Numpad5] restart with a random rigid body
** kbd:[Enter], kbd:[Numpad0], kbd:[Spacebar] split all shapes
** kbd:[L bracket], kbd:[R bracket] rotate the splitting plane
