...
:url-tutorial: https://github.com/stephengold/Libbulletjme/blob/master/TutorialApps/src/main/java/jme3utilities/tutorial
...
Libbulletjme incorporates Khaled Mamou's
...
* Libbulletjme provides 16 types of collision shapes,
